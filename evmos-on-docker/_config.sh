...
if [ "$CHAIN_NO" = "1" ]; then
    ...
    export SRC_VER="$EVMOS_CHAIN_1_BRANCH"
    export EVMOS_REPO="$CHAIN_1_GIT_REPO"
    ...
    export SRC_VER="$EVMOS_CHAIN_2_BRANCH"
    export EVMOS_REPO="$CHAIN_2_GIT_REPO"
...
echo "- Source code on branch: $SRC_VER"
